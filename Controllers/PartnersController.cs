...
namespace Deliverable2.Controllers
{
    public class PartnersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PID,PartnerName,ContactDetails")] Partner partner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PID,PartnerName,ContactDetails")] Partner partner)
        {
            if (ModelState.IsValid)
            {
